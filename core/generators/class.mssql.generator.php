<?php
    ...
    class MSSQLGenerator implements GeneratorInterface
    {
        private $project;
        private $code;
        private $keywords;
        ...
        {
            $this->code .= 'CREATE DATABASE '. $this->project->get('name') .' COLLATE '. $this->project->get('charset') .';';
            $this->code .= 'GO'.PHP_EOL;
            $this->code .= 'USE '. $this->project->get('name') .';';
            $this->code .= 'GO'.PHP_EOL;
        }
